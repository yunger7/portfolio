...
export function MediumSize({ delay, setHover }) {
	return (
		...
		>
			<motion.g
				transform="translate(290.34911431878703 291.5252095786466)"
				animate={{
					transform: [
						null,
						"translate(301.34353888226735 299.84250987700284)",
						"translate(305.97639548929993 293.14603752652914)",
					],
				}}
